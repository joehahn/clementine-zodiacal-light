...
;using the short-exposure lab data.
...
;Subtract dark-current, destreak, and average the images.
f012=[[[flat0]],[[flat1]],[[flat2]]]
f012=f012-dark_current
for t=0,2 do f012(0,0,t)=destreak(f012(*,*,t),0.03)
...
for i=0,Nzones-1 do begin $
  ...
  good=where((rad ge 200) and (rad lt 270) and (tmplt eq 1)) & $
