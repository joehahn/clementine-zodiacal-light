...
correction=1.0-1.45*angle^2
pix=where(angle*r2d gt 20.0)
err_pix=where((angle*r2d lt 10.0) and (good_pixels eq 1))
...
writefits, 'flatfield_long_exp.fits', flatfield
writefits, 'good_pix_long_exp.fits', good_pixels
