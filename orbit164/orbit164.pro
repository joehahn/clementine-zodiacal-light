...
tvscl,flatfield>0.65<1.05
x_opt=191.0	;Coordinates for the optical center.
y_opt=286.0
flat_prof=profile_idl(flatfield,x_opt,y_opt,r,err,flatfield*0.0)
err=stdev(flatfield(254:274,444:464))
radial,rad,x_opt,y_opt,Nx,Ny
flatfield(90,78)=0.980*flat_prof(rad(90:145,78:158))+ $
  0.8*err*randomn(s,56,81)
tvscl,flatfield>0.65<1.05,Nx,0
