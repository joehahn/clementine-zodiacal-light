%
%       latex clementine_v3
%       dvips -Pcmz -Pamz -o clementine_v3.ps clementine_v3
%       distill clementine_v3.ps
%
...
\begin{figure}
\epsscale{1.0}
\vspace*{-15ex}\plotone{figs/mosaic.ps}
\vspace*{-15ex}\figcaption{A mosaic of seven fields of the inner zodiacal light
...
\begin{figure}
\epsscale{1.0}
\vspace*{-24ex}\plotone{figs/fit_nu_ast=1.0_nu_occ=2.0.ps}
\vspace*{-24ex}\figcaption{The narrow black curves are isophotes
