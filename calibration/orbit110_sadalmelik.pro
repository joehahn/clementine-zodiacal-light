...
t_star=bytarr(Nx,Ny)
t_star(x1-radius:x1+radius,y1-radius:y1+radius)=1
...
plot,flatfield(pix_c),psym=1,yrange=[0.7,1.1]
...
for t=0,Nimages-1 do begin $
  tvscl,images(*,*,t)*max(exp_time)/exp_time(t)>0<15 & $
