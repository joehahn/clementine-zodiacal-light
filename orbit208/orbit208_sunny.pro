...
;sunny's original version of orbit208.pro
...
lead_name='/net/lpiip2/u2/hahn/clementine/new208/conversions/lba'
...
coeff=[ 36.6, 21.4 ]		;anticipated dark-current
...
;  plots,exp_time(t),dark_adj(t)/exp_time(t),psym=6 & $
;endfor
;coeff_adj=poly_fit(exp_time,dark_adj,1)
...
;On first entry (e.g., if lunar_limb=0), click the mouse
