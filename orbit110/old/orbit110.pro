...
alpha3	=  5.998042
delta3	= -0.276125
x4=175.0			;Aquarius 88
y4=492.0
alpha4	=  6.062605
delta4	= -0.369528
x5=89.0				;Fomalhaut = HD 216956
y5=565.25
alpha5	=  6.011136
delta5	= -0.517006
;x6=62.8			;Sadalsud (not used)
;y6=147.4			;mis-identified?
;alpha6	=  5.635489
;delta6	= -0.097235
...
for t=0,Nimages-1 do begin $
  ...
  ;tvscl,im*max(exp_time)/exp_time(t)>(-10)<10 & $
  ;tvscl,imd*mask(*,*,t)*max(exp_time)/exp_time(t)>(-10)<10,Nx,0&$
  images_dd(0,0,t)=imd & $
endfor
plot,exp_time,exp_time,yrange=40*[-1,1],nodata=1,ystyle=1, $
...
;add residual flux to images
for t=0,Nimages-1 do $
  images(0,0,t)=images(*,*,t)+residual_flux*exp_time(t) 
plot,images(x_dark0:x_dark1,y_dark0:y_dark1,*),psym=3
